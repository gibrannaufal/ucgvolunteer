...
<body>
    ...
    <main class="content">
        <h2>Services That We Provides</h2>

        <div class="cards-list">
            <div class="card">
                <div class="foto">
                    <img src="<?php echo base_url(); ?>/assets/img/foto.jpg" alt="">
                </div>

                <div class="info">
                    <h3>Service Example</h3>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum consectetur, suscipit nisi eius pariatur cupiditate.</p>
                </div>

                 <a class="our-team-button" href="<?php echo base_url(); ?>home/team">Our Team</a>
    ...
    <script src="<?php echo base_url(); ?>/asssets/js/services.js"></script>
</body>
</html>